...
# On a UNIX-like system, the above enables panmk to run independently
...
## Copyright Roger Fu
##         (modifications from latexmk -> panmk)
## Copyright John Collins
##         (original latexmk copyright)
...
$My_name = 'Panmk';
$version_num = '1.00b';
$version_details = "$My_name, Roger Fu, 05 April 2019";
